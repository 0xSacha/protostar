...
@storage_var
func claimedTimestamp(vault: felt) -> (res : felt):
end
...
@view
func getClaimedTimestamp{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(vault: felt) -> (
        timestamp : felt):
    let (res) = claimedTimestamp.read(vault)
...
@external
func setClaimedTimestamp{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        vault: felt, timestamp : felt):
    claimedTimestamp.write(vault, timestamp)
    return ()
end
