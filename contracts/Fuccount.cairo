...
func shares_total_supply{
    ...
    let (shares_total_supply_: Uint256) = FuccountLib.get_shares_total_supply()
    return (shares_total_supply_)
end
...
@view
func get_share_pricePurchased{
        syscall_ptr: felt*, 
        pedersen_ptr: HashBuiltin*, 
        range_check_ptr
    }(tokenId: Uint256) -> (res: Uint256):
    let (sharePricePurchased_: Uint256) =  FuccountLib.get_share_pricePurchased(tokenId)
