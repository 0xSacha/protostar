...
alloc_locals
    ...
    #  tempvar f1_contract_bis

    #         %{ 
    # ids.f1_contract_bis = context.F1
    # %}
    ...
    # assert integr_.contract = f1_contract_bis
    ...
    # let (assetId_len:felt, assetId:Uint256*, assetAmount_len:felt,assetAmount:Uint256*) = IFuccountMock.ownerShares(f1_contract_bis,ADMIN)
    ...
    # let (mintedBlockTimesTamp_:felt) =  IFuccountMock.getMintedTimesTamp(f1_contract_bis, id )
    # let (sharePricePurchased_:Uint256) = IFuccountMock.getSharePricePurchased(f1_contract_bis, id)
    # let (totalId_:Uint256) = IFuccountMock.totalId(f1_contract_bis)
    # let (sharesTotalSupply:Uint256) = IFuccountMock.sharesTotalSupply(f1_contract_bis)
